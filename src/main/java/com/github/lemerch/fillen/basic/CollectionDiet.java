...
public class CollectionDiet extends Fillen.Diet{
    ...
    public Object menu(Ingredients ingredients) throws UserException {
        if (getAllInterfaces(ingredients.type).contains(Collection.class)) {
            ...
            Object callback = seeback(
                    ingredients.setType(ingredients.generic.getList().get(0))
    ...
    public Collection collectionGenerate(Class<?> type) throws UserException {
        ...
        try {
            ...
            throw new UserException("I cant generate collection from type `" + type + "`", e);
        }
    }
}
